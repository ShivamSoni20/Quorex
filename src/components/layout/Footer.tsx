          ...
          <div className="space-y-4">
             <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center font-black text-xs shadow-xl">QX</div>
                 <span className="text-xl font-bold tracking-tight text-white font-syne uppercase">Quorex</span>
             </div>
           ...
           <div className="flex flex-col md:flex-row items-start md:items-center gap-10 text-[10px] font-bold uppercase tracking-[0.2em]">
