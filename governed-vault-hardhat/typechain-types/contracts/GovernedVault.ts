...
export interface GovernedVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GUARDIAN_ROLE"
...
export interface GovernedVault extends BaseContract {
  connect(runner?: ContractRunner | null): GovernedVault;
  waitForDeployment(): Promise<this>;

  interface: GovernedVaultInterface;
  ...
  filters: {
    ...
    "StrategyChanged(address,address)": TypedContractEvent<
      StrategyChangedEvent.InputTuple,
      StrategyChangedEvent.OutputTuple,
      StrategyChangedEvent.OutputObject
    >;
