...
export interface VaultTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface VaultTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): VaultTimelock;
  waitForDeployment(): Promise<this>;

  interface: VaultTimelockInterface;
